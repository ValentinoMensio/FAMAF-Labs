...
def connect_to_server(server_name):
    ...
    """
    # Obtengo la dirección IP del servidor usando su nombre de dominio
    ip_address = socket.gethostbyname(server_name) 


    sys.stderr.write("Contactando al servidor en %s...\n" % ip_address)

    # Creo un nuevo socket para la conexión
    new_socket = socket.socket()
    # Conecto el socket a la dirección IP del servidor y al puerto 80 (HTTP)
